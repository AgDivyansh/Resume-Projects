...
import { Client, account, ID, Account, Databases, Storage, Query } from "appwrite"
...
export class Service {
    ...
    async getPosts (queries = [Query.equal("stauts", "active")])
    {
        try {
            ...
            console.log("Appwrite congig :: getPosts (return all the posts) :: error :: ", error);
